...
\section{Abstract zur Bachelorthesis}
    ...
    \begin{minipage}{0.45\columnwidth}
        \begin{flushright}
            ...
            %\includesvg[height=10mm,inkscapelatex=false]{bilder/firmenlogo.svg}
            %\includegraphics[height=10mm]{bilder/firmenlogo.png}
        \end{flushright}
    \end{minipage}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\columnwidth}{p{3.3cm} X}
            ...
            \textbf{Thema:}                     & \titel \\
            \textbf{Jahr:}                      & \jahr \\
            \multirow{2}{*}{\textbf{Betreuer:}} & \betreuereins\hspace*{2cm}(\institutioneins) \\
                                                & \betreuerzwei\hspace*{2cm}(\institutionzwei) \\
        \end{tabularx}
    \end{table}
    \fbox{
        \centering
