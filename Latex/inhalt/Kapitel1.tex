...
\bild[0.5]{../vorlage/ba-gc-logo}{Text zu einem Bild}{label1} %!bei Dateien in "bilder" ohne "../"
\subsection{Vektorgrafiken}
\svg[0.5]{../vorlage/ba-gc-logo}{Text zu einer \ac{SVG}-Datei}{label2} %!bei Dateien in "bilder" ohne "../"
