...
\definecolor{mintedbg}{HTML}{fbfbfb}
...
\setminted{
    ...
    linenos,
    bgcolor=mintedbg,
    style=paraiso-light %! siehe https://pygments.org/demo/#try, andere hübsche Optionen: solarized_light, rainbow_dash, gruvbox-light
}
